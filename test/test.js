    ...
    (function (html) {
        html.commands = {
            ...
            textContent: function (context) {
                new ares.Watcher(context.exp, context.scope, function (value) {
            ...
            css: function (context) {
                ...
                // 生成订阅器
                new ares.Watcher(context.exp, context.scope, function (params) {
            ...
            for: function (context) {
                ...
                // 添加订阅
                new ares.Watcher(arrName, context.scope, function (value) {
                    // 清理原始显示
...
(function (ares) {
    ...
    (function (html) {
        var HTMLCompiler = (function () {
            ...
            HTMLCompiler.compile = function (node, scope) {
                if (node.nodeType == 3) {
                    // 是个文本节点
            ...
            HTMLCompiler.compileTextContent = function (node, scope) {
                if (HTMLCompiler._textExpReg.test(node.nodeValue)) {
                    var exp = HTMLCompiler.parseTextExp(node.nodeValue);
            ...
            HTMLCompiler.parseTextExp = function (exp) {
...
ares.bind({
    ...
    testFunc: function (evt) {
        ...
        setTimeout(function () {
            _this.testArr.push("TWICE !!!");
        }, 2000);
        setTimeout(function () {
            _this.testArr.splice(3, 1, "THIRD TIMES!!!");
        }, 4000);
        setTimeout(function () {
            _this.testArr.$set(0, "love");
        }, 6000);
    }
